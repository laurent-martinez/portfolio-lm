...
import projectPicture from '../../public/exampleSite.png';
             ...
             <div className='relative overflow-x-scroll overflow-y-hidden scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 w-full flex snap-x snap-mandatory z-20'>
                { projects.map((project,index) =>(
                    <div key={index} className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20'>
                        <Image src={projectPicture} alt='p14 photo' className='h-[300px] w-[300px] md:h-[400px] md:w-[500px] mx-0'/>
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                            <h4 className='font-semibold text-center text-2xl whitespace-nowrap sm:text-4xl'><span className='underline decoration-[#F7AB0A]/50'>Agency site n°1</span> </h4>
                            <p className='text-lg text-center line-clamp-6 lg:line-clamp-none md:text-left'>This website is designed to help you quickly and easily register as a new employee of our company. By completing the registration process, you will gain access to our employee portal,
