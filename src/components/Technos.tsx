...
export default function Technos({}: Props) {
  return (
    ...
    className='h-screen flex flex-col text-center md:text-left xl:flex-row max-w-[2000px] min-h-screen xl-px-10 relative justify-center  mx-auto items-center'>
       <h3 className='absolute top-14 sm:top-10 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
       <h3 className='absolute top-24 sm:top-36 uppercase tracking-[3px] text-gray-500 text-sm'>Hover over a skill for current proficiency</h3>
